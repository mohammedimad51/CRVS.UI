...
namespace CRVS.UI.Controllers
{
    public class DistrictsController : Controller
    {
        ...
        public DistrictsController(IBaseRepository<District> _repository, ApplicationDbContext _db, IWebHostEnvironment environment, IConfiguration _configuration)
        {
                ...
                if (postedFile != null)
                {
                    ...
                    using (SqlConnection con = new SqlConnection(conString))
                    {
                        using (SqlBulkCopy sqlBulkCopy = new SqlBulkCopy(con))
                        {
                            ...
                            sqlBulkCopy.DestinationTableName = "dbo.Districts";
