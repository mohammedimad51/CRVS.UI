...
namespace CRVS.UI.Controllers
{
    public class HealthInstitutionsController : Controller
    {
        ...
        public HealthInstitutionsController(IBaseRepository<HealthInstitution> _repository, ApplicationDbContext _db, IWebHostEnvironment environment, IConfiguration _configuration)
        {
        ...
        public IActionResult Import(IFormFile postedFile)
        {
                ...
                if (postedFile != null)
                {
                    ...
                    using (SqlConnection con = new SqlConnection(conString))
                    {
                        using (SqlBulkCopy sqlBulkCopy = new SqlBulkCopy(con))
                        {
                            ...
                            sqlBulkCopy.DestinationTableName = "dbo.HealthInstitutions";

                            //[OPTIONAL]: Map the Excel columns with that of the database table.
                            sqlBulkCopy.ColumnMappings.Add("HealthInstitutionId", "HealthInstitutionId");
                            sqlBulkCopy.ColumnMappings.Add("HealthInstitutionName", "HealthInstitutionName");
            ...
            return RedirectToAction("Index", "HealthInstitutions");
        }
